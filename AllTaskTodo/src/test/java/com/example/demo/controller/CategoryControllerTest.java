...
class CategoryControllerTest {
  ...
  @Test
  @DisplayName("POST /categories: nameが空文字の場合400を返すこと")
  void testPostCategories_BlankName_ShouldReturnBadRequest() throws Exception {
    String requestBody = """
        {
          "name": "",
          "sortOrder": 5
    ...
    mockMvc.perform(post("/categories")
        ...
        .andExpect(jsonPath("$.details.name").value("カテゴリ名を入力してください"));
  }
  ...
  @Test
  @DisplayName("PATCH /categories/sort-order: sortOrderがnullの場合400を返すこと")
  void testPatchCategorySortOrder_NullSortOrder_ShouldReturnBadRequest() throws Exception {
    String requestBody = """
        [
          { "id": 1, "sortOrder": null }
        ]
  ...
  @Test
  @DisplayName("PATCH /categories/sort-order: 存在しないカテゴリの場合404を返すこと")
  void testPatchCategorySortOrder_NotFoundCategory_ShouldReturnNotFound() throws Exception {
    String requestBody = """
        [
          { "id": 999, "sortOrder": 1 }
        ]
